...
getStartX: cropCoordinate[0] = startX;//find next coordinate
...
getEndX: cropCoordinate[2] = endX;//find next coordinate
...
getEndY: cropCoordinate[3] = endY;//find next coordinate
